...
var Policies = class {
  ...
  runMergeFunction(existing, incoming, { field, typename, merge: merge3, path }, context2, storage) {
    ...
    const streamInfo = (_c = (_b = (_a2 = context2.extensions) == null ? void 0 : _a2[streamInfoSymbol]) == null ? void 0 : _b.deref()) == null ? void 0 : _c.peekArray(path);
    if (streamInfo) {
  ...
  processSelectionSet({
    ...
    this.flattenFields(
      ...
      if (value !== void 0) {
        ...
        } else if (hasDirectives(["stream"], field) && Array.isArray(incomingValue) && ((_a2 = context3.extensions) == null ? void 0 : _a2[streamInfoSymbol])) {
          childTree.info = {
            field,
            typename,
  ...
  refetch(variables) {
    ...
    if (__DEV__ && variables && hasOwnProperty6.call(variables, "variables")) {
      ...
      if (!vars || !vars.some((v) => v.variable.name.value === "variables")) {
        __DEV__ && invariant3.warn(81, variables, ((_a2 = queryDef.name) == null ? void 0 : _a2.value) || queryDef);
      }
    }
...
var QueryManager = class {
  ...
  getObservableFromLink(query, context2, variables, fetchPolicy, extensions, deduplication = (context2 == null ? void 0 : context2.queryDeduplication) ?? this.queryDeduplication) {
    let entry = {};
...
//# sourceMappingURL=chunk-ZBHLZPIQ.js.map
